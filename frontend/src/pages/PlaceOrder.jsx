  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t border-gray-300 '>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px] '>
        ...
        <input onChange={onChangeHandler} name='phone' value={formData.phone} className='border border-gray-300 rounded py-1.5 px-3.5 w-full no-spinner' type="number" placeholder='Phone Number' required />
        ...
        <div className='flex gap-3'>
          <input onChange={onChangeHandler} name='pincode' value={formData.pincode} className='border border-gray-300 rounded py-1.5 px-3.5 w-full no-spinner' type="number" placeholder='Pin Code' required />
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row mt-3 text-gray-300'>
